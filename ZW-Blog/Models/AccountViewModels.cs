...
namespace ZW_Blog.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required]
        [StringLength(20, ErrorMessage = "Your first name must be at least 2 characters long.", MinimumLength = 2)]
        [Display(Name = "First Name")]
        public string FirstName { get; set; }

        [Required]
        [StringLength(20, ErrorMessage = "Your last name must be at least 2 characters long.", MinimumLength = 2)]
